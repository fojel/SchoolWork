/*
Escribir un formulario en html y un script en JS para imprimir el area del 
rectangulo creando una clase llamada 'CRectangulo' con una funcion  llamada 'CalcularArea' que devuelve el area.
